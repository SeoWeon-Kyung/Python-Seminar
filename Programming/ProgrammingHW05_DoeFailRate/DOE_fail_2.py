...
plt.show()
"""
g_c4004 = sns.displot(data=fail_data[fail_data["moduleconfig"] == "C4004"],  
                x="offset_z", 
                hue='sfr',
                multiple="stack", 
                hue_order=['cm2060', 'cm20', 'cm60'],
                ...
                height=4,
                aspect=1)
g_c4004.set_titles(col_template='C4004 {col_name}')
g_c4004.set_xticklabels(rotation=90)
g_c4004.tight_layout()
#plt.show()

# C4010 Graph
g_c4010 = sns.displot(data=fail_data[fail_data["moduleconfig"] == "C4010"],  
                x="offset_z", 
                hue='sfr',
                multiple="stack", 
                hue_order=['cm2060', 'cm20', 'cm60'],
                ...
                height=4,
                aspect=1)
g_c4010.set_titles(col_template='C4010 {col_name}')
g_c4010.set_xticklabels(rotation=90)
g_c4010.tight_layout()
#plt.show()
# C4011 Graph
g_c4011 = sns.displot(data=fail_data[fail_data["moduleconfig"] == "C4011"],  
                x="offset_z", 
                hue='sfr',
                multiple="stack", 
                hue_order=['cm2060', 'cm20', 'cm60'],
                ...
                height=4,
                aspect=1)
g_c4011.set_titles(col_template='C4011 {col_name}')
g_c4011.set_xticklabels(rotation=90)
g_c4011.tight_layout()
plt.show()
"""
"""
sns.histplot(data=fail_data[fail_data["moduleconfig"] == "C4010"], 
                hue='sfr', 
                x="offset_z", 
                multiple="stack", 
                hue_order=['cm20', 'cm60', 'cm2060'],
                ax=axs[1])
axs[1].set_title('C4010')
sns.histplot(data=fail_data[fail_data["moduleconfig"] == "C4011"], 
                hue='sfr', 
                x="offset_z", 
                multiple="stack", 
                hue_order=['cm20', 'cm60', 'cm2060'],
                ax=axs[2])
axs[2].set_title('C4011')
"""
#axs[0].set_title('C4004')
#hplotc4010 = axs[1].histplot(data=fail_data[fail_data["moduleconfig"] == "C4010"], hue='sfr', x="offset_z", multiple="stack")
#axs[1].set_title('C4010')
#hplotc4011 = axs[2].histplot(data=fail_data[fail_data["moduleconfig"] == "C4011"], hue='sfr', x="offset_z", multiple="stack")
#axs[2].set_title('C4011')
