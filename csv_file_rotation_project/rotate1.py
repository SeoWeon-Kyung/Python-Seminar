...
#### 파일 오픈 후 리스트 형태로 변경 ####
f_in = open("../Python-Seminar/csv_file_rotation_project/copy_a.csv", 'r', encoding='utf-8')  # csv 파일 객체에 열기    , encoding='utf-8'
...
f_out = open("../Python-Seminar/csv_file_rotation_project/output_a.csv", 'w', encoding='utf-8', newline='')  # write할 파일 미리 해당위치에 만들어놓아야 함. 
